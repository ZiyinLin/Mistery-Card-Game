...
using namespace std;
        ...
        void ServerGame::handlePlayerAction(const PlayerAction& action){
            //处理玩家动作并更新游戏状态
        ...
        //广播动作给所有客户端
        void ServerGame::broadcastAction(const PlayerAction& action) {
        ...
        void ServerGame::revealHideCard(){
        ...
        void ServerGame::addPointedCard(card_pointer card){
        ...
        void ServerGame::announceWinner(){
            //宣布获胜者
        }
        ...
        //接收玩家动作
        PlayerAction ServerGame::receivePlayerAction(){
            for (QTcpSocket* clientSocket : clients) {
        ...
        void ServerGame::onNewConnection() {
        ...
        void ServerGame::onClientDisconnected() {
            QTcpSocket *clientSocket = qobject_cast<QTcpSocket*>(sender());
