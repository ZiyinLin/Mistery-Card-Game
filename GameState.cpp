...
using namespace std;
       ...
       vector<Player*> GameState::getAllPlayers(){
          return players;
       }
       ...
       Player* GameState::getPlayer(string playerID){
       ...
       void GameState::setCanNormalPlay(string playerID, bool normal){
           Player* player = this->getPlayer(playerID);
           player->setCanNormalPlay(normal);
       }

       void GameState::sendErrorMessage(string playerID, string error){

       }

       // 序列化 PlayerAction
      Message GameState::sendPlayerAction(PlayerAction& action) {
        return action.toMessage();
    }

    // 反序列化 PlayerAction
      PlayerAction GameState::receivePlayerAction(const Message& message) {
